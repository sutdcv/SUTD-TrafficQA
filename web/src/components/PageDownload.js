        ...
        <div>
            <div className="jumbotron jumbotron-fluid py-5 bg-dark">
                ...
                <div className="mt-5 px-5 container text-light text-center">
                    <p className="alert alert-secondary">
                        ...
                        Dataset access link will be sent to your email address.
            ...
            <div className={"container my-4 py-4 px-3 jumbotron shadow"} style={{minWidth: 400}}>
                <p className="mb-5 alert alert-success">
                    ...
                    the dataset access link will only be sent after the competition. To get early access to the dataset, you are encouraged to participate the above-mentioned competition!</p>
