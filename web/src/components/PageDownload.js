        ...
        <div>
            ...
            <div className={"container my-4 py-4 px-3 jumbotron shadow"} style={{minWidth: 400}}>
                <p className="mb-5 alert alert-success">
                    ...
                    the dataset access link will only be sent after the competition. To get early access to the dataset, you are encouraged to participate above-mentioned competition!</p>
