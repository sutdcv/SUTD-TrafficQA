...
const PageDetails = () => {
    return (
        <div>
            ...
            <div className={"container my-4 py-3 px-3 jumbotron shadow"} style={{minWidth: 400}}>
                <div className={"container pb-5"}>
                    <h3>Example</h3>
                    <img src={exampleImg} style={{maxWidth: "100%"}} />
                </div>
                <div className={"container d-flex flex-column align-items-start"}>

                    <h3 className="mt-3">Annotations (Text QAs)</h3>
                    ...
                    <h3 className="mt-3">Video Features</h3>
                    <DownloadButton text={"Request Download"} href={"#download"} disabled={false} openNewTab={true}/>
                    ...
                    <h3 className="mt-3">Raw Videos</h3>
                    <DownloadButton text={"Request Download"} href={"#download"} disabled={false} openNewTab={true}/>
